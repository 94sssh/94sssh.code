---
title: 모던 자바스크립트 Deep Dive - 34. 이터러블
date: '2024-08-21T00:00:00'
tags: ['javascript', 'book', 'deepdive']
draft: false
summary: 모던 자바스크립트 Deep Dive - 34. 이터러블
layout: PostSimple
---
...
ES6에서는 순회 간으한 데이터 컬렉션을 이터레이션 프로토콜을 준수하는 이터러블로 통일해 `for ... of`문, 스프레드 문법, 배열 디스트럭처링 할당의 대상으로 사용할 수 있도록 일원화했다.
